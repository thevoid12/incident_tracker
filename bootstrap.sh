...
# pgsql
# Opening a psql session inside the container and feeding 
# the schema SQL file from the host into that session.
docker exec -i inctra_pgsql psql -U postgres -d postgres < ./backend/app/db/base_schema.sql
